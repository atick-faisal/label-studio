...
## Annotation Hub Enterprise 2.23.0
...
Unlike the the standard GCS connection using application credentials, this allows Annotation Hub to request temporary credentials when connecting to your storage.
