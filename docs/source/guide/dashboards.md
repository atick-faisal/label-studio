...
meta_title: Dashboard in Annotation Hub
meta_description: Use Annotation Hub dashboards to monitor performance and progress.
section: "Create & Manage Projects"
---

You can use the Annotation Hub Enterprise dashboards to help visualize your labeling progress across projects and resources. 

See the following video for a brief overview of the analytics available in Annotation Hub Enterprise:
