...
## Annotation Hub Enterprise 2.2.10

<div class="onprem-highlight">Bug fixes</div>

This section highlights the bug fixes in Annotation Hub Enterprise 2.2.10.

### Bug fixes
Annotation Hub 2.2.10 includes the following bug fixes:
