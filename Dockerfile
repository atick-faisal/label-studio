...
# This Dockerfile builds a Annotation Hub environment.
...
# 5. "prod" - Creates the final production image with the Annotation Hub, Nginx, and other dependencies.
...
# Copy essential files for installing Annotation Hub and its dependencies
