...
## Annotation Hub Enterprise 2.20.0
...
The video frame classification template is now available in the Annotation Hub app as well as [the documentation](/templates/video_frame_classification).
...
This release includes an upgrade to Django 5. As part of this change, Annotation Hub now requires PostgreSQL version 13+. 

### Bug fixes

- Fixed an issue where the Annotation Hub version as displayed in the side menu was not formatted properly.
