...
order: 906
is_new: t
meta_title: Create a ranked dataset for building a RAG system for LLMs with Annotation Hub
meta_description: Create a ranked dataset for building a RAG system for LLMs with Annotation Hub for your machine learning and data science projects.
---
...
Looking for a model to get started with the fine-tuning process? Check out [our guide on the Annotation Hub Blog](https://labelstud.io/blog/five-large-language-models-you-can-fine-tune-today/).
...
Using the Python SDK, import the dataset with input prompts into Annotation Hub using the `PROJECT_ID` of the project you've just created.
...
Using python SDK you can export the dataset with annotations from Annotation Hub
