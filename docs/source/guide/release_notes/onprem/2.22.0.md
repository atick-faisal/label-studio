...
## Annotation Hub Enterprise 2.22.0
...
- The Annotation Hub URL format has been updated so that you can now link to specific workspaces.
...
- UI fixes to ensure consistency in styles across Annotation Hub.
