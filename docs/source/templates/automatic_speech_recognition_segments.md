...
meta_description: Template for audio transcription for automatic speech recognition segmentation use cases with Annotation Hub for your machine learning and data science projects.
---
