...
## Annotation Hub Enterprise 2.2.9

<div class="onprem-highlight">Dynamic Labels template, Comments column in the Data Manager, decommissioning MinIO</div>

This section highlights the breaking changes, new features and enhancements, and bug fixes in Annotation Hub Enterprise 2.2.9. 

### Breaking changes
Annotation Hub Enterprise 2.2.9 includes the following breaking change:

- This release decommissions MinIO as a service.

### New features and enhancements 
Annotation Hub Enterprise 2.2.9 introduces the following new features and enhancements.
...
### Bug fixes
Annotation Hub 2.2.9 includes the following bug fixes:
