## System requirements
You can install Annotation Hub on a Linux, Windows, or MacOSX machine running Python 3.6 or later.

### Port requirements
Annotation Hub expects port 8080 to be open by default. To use a different port, specify it when starting Annotation Hub. See [Start Annotation Hub](https://labelstud.io/guide/start). 
...
For more on using Annotation Hub at scale and labeling performance, see [Start Annotation Hub](https://labelstud.io/guide/start).
