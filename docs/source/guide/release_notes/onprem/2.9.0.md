...
## Annotation Hub Enterprise 2.9.0
...
- Fixed an issue where credential validation was failing in the Annotation Hub interface for cloud storages configured using SDK.
