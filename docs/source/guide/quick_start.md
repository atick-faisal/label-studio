...
order: 50
order_enterprise: 0
meta_title: Quick start guide for Annotation Hub
meta_description: Quick start guide for installing Annotation Hub and creating a new project. 
...
2. Start Annotation Hub
```bash
label-studio start
```

1. Open Annotation Hub at `http://localhost:8080`.
...
!!! info Tip
    For a quickstart tutorial that includes demo data, see [Zero to One: Getting Started with Annotation Hub](https://labelstud.io/blog/zero-to-one-getting-started-with-label-studio/). 
