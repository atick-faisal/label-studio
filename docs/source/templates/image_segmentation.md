...
meta_description: Template for performing semantic segmentation with brush masks with Annotation Hub for your machine learning and data science projects.
---
