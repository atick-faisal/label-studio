...
meta_description: Annotation Hub tutorial for Chatbot response generation with HuggingFace's GPT2 model
...
it connects a GPT2-like language model to the Annotation Hub UI, giving you an opportunity to explore different text responses based on the chat history.
...
2. Start Annotation Hub and create a new project.
