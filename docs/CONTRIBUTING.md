# Contribute to the Annotation Hub documentation

Thank you for investing your time in contributing to our project! Any contribution you make will be reflected on the Annotation Hub documentation site at https://labelstud.io/guide/, or https://labelstud.io/templates/ if you [contribute a template](#Contribute-a-template).
...
For changes that you contribute to any of the Annotation Hub repositories, please do the following:
...
Some types of documentation that you might want to contribute to Annotation Hub:
...
All Annotation Hub templates are specific to a machine learning use case, such as Natural Language Processing, Computer Vision, Conversational AI, and others. 
