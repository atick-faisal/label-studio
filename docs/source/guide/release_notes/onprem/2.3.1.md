...
## Annotation Hub Enterprise 2.3.1
...
This section highlights the breaking changes, new features and enhancements, and bug fixes in Annotation Hub Enterprise 2.3.1.
...
### Breaking changes
Annotation Hub Enterprise 2.3.1 includes the following breaking change:
...
Annotation Hub Enterprise 2.3.1 introduces the following new features and enhancements.
...
### Bug fixes
Annotation Hub 2.3.1 includes the following bug fixes:
...
- Added example output for `HyperTextLabels` in the Annotation Hub documentation suite.