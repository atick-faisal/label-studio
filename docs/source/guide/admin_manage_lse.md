...
!!! note
    If you are using SSO/SAML or SCIM, you can map groups to roles on the organization level and the project level. For more information, see [Set up SSO authentication for Annotation Hub](auth_setup) and [Set up SCIM2 for Annotation Hub](scim_setup). 
...
- If you only have one organization in your Annotation Hub instance, use `0`.
