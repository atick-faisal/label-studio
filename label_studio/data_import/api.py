    ...
    decorator=swagger_auto_schema(
        ...
        operation_description="""
            ...
            **Note:** Imported data is verified against a project *label_config* and must
            ...
            Update this example to specify your authorization token and Annotation Hub instance host, then run the following from
            the command line.
            ...
            Update this example to specify your authorization token, Annotation Hub instance host, and file name and path,
