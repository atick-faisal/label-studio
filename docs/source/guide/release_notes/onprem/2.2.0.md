...
## Annotation Hub Enterprise 2.2.0
...
This section highlights the new features and enhancements in Annotation Hub Enterprise 2.2.0.

### New features and enhancements 
Annotation Hub Enterprise 2.2.0 introduces the following new features and enhancements.

- Annotation Hub Enterprise 2.2.0 introduces the System for Cross-domain Identity Management (SCIM) version 2.0 standard. System for Cross-domain Identity Management (SCIM) is a popular protocol to manage access for services and applications across an organization. Use the [SCIM guide](scim_setup.html) to set up SCIM integration to manage access to Annotation Hub Enterprise in your organization.
