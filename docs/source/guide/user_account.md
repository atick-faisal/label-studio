...
meta_description: Update your user account and settings in Annotation Hub
...
After you create an account in Annotation Hub, you can update the following:
...
Use this section to opt out of Annotation Hub news and tips sent to your email address. 

## Membership info

In this section, you can find information about your organization, such as when the organization was created and the email address of the Owner (the user who initially created the Annotation Hub organization).
...
While personal access tokens work seamlessly with the Annotation Hub SDK, if you are using HTTP API requests, you will need to take extra steps. See [Personal access tokens and the API](access_tokens#Personal-access-tokens-and-the-API). 
