...
## Annotation Hub Enterprise 2.14.0
...
#### Refreshed Annotation Hub interface

This release includes a new UI with updated colors and fonts, giving it a sleek new look while maintaining the same intuitive navigation you're familiar with. All Annotation Hub tools, features, and settings are still in the same place, ensuring a smooth transition.
