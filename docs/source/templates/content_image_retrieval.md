...
meta_description: Template for labeling data for content-based image retrieval tasks with Annotation Hub for your machine learning and data science projects.
---
