...
![Screenshot of moderation modal in Annotation Hub](/images/plugins/moderation.png)
 ...
 * work with no errors.
 *
 * The plugin uses Annotation Hub's beforeSaveAnnotation event which is triggered before
