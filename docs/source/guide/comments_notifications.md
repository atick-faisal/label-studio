...
meta_title: Comment in Annotation Hub Enterprise
...
Comments are a Annotation Hub Enterprise feature that allows communication between reviewers and annotators:
