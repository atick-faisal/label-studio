...
type: tags
order: 201
meta_title: Customize the Annotation Hub User Interface
meta_description: Customize the Annotation Hub labeling interface using XML-like tags for data annotation tasks in machine learning and data science projects.
---

You can use XML-like tags in Annotation Hub to configure the labeling interface. Annotation Hub uses three different types of tags to manage labeling:
