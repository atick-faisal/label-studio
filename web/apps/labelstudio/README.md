...
The Annotation Hub App is the cornerstone of the frontend aspect of Annotation Hub. This React-based application is where the magic of frontend development for Annotation Hub occurs. In this app, developers have the freedom and capability to create new pages and determine how libraries are utilized within the Annotation Hub environment. It's a purely frontend module, dedicated to crafting and refining the user interface and user experience aspects of Annotation Hub.
...
- **`yarn ls:watch`: Build LSF continuously**
    - Automatically builds the Annotation Hub on every change, providing a real-time development experience.
