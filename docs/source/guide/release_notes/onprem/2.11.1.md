...
## Annotation Hub Enterprise 2.11.1
...
This release streamlines the way ML models and LLMs are connected to Annotation Hub with a focus on security and simplified user experience. 
...
Annotation Hub Enterprise users can add custom models, or reference a [new examples library](https://github.com/HumanSignal/label-studio-ml-backend/tree/master) to connect popular models, including Segment Anything, OpenAI, Grounding DINO, select Hugging Face models, Tesseract, and more.
...
For more information, see [Integrate Annotation Hub into your machine learning pipeline](ml).
