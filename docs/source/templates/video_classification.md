...
meta_description: Template for video classification tasks with Annotation Hub for your machine learning and data science projects.
---
...
Use the [Video](/tags/video.html) object tag to display video clips in Annotation Hub Enterprise:
```xml
<Video name="video" value="$video"/>
```
...
Use the [HyperText](/tags/hypertext.html) tag to display video clips to annotators in Annotation Hub:
```xml
<HyperText name="video" value="$html"></HyperText>
```
