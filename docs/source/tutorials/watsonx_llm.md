---
title: Integrate WatsonX with Annotation Hub
type: guide
tier: all
order: 15
hide_menu: true
hide_frontmatter_title: true
meta_title: Integrate WatsonX with Annotation Hub
categories:
    - Generative AI
...
# Integrate WatsonX to Annotation Hub

WatsonX offers a suite of machine learning tools, including access to many LLMs, prompt
refinement interfaces, and datastores via WatsonX.data. When you integrate WatsonX with Annotation Hub, you get 
...
to your Annotation Hub project under the `models` section in the settings. To use the WatsonX.data integration, 
...
For a video demonstration, see [Integrating Annotation Hub with IBM WatsonX](https://www.youtube.com/watch?v=9iP2yO4Geqc).
...
The following parameters allow you to link the WatsonX models to Annotation Hub:

- `LABEL_STUDIO_URL` - Specify the URL of your Annotation Hub instance. Note that this might need to be `http://host.docker.internal:8080` if you are running Annotation Hub on another Docker container.
- `LABEL_STUDIO_API_KEY`- Specify the API key for authenticating your Annotation Hub instance. You can find this by logging into Annotation Hub and and [going to the **Account & Settings** page](https://labelstud.io/guide/user_account#Access-token).
...
The following parameters allow you to use the webhook connection to transfer data from Annotation Hub to WatsonX.data:
