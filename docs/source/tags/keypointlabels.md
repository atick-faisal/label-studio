...
meta_description: Customize Annotation Hub with the KeyPointLabels tag to label keypoints for computer vision machine learning and data science projects.
---
