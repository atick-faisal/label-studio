...
meta_description: Manage existing user accounts in Annotation Hub Community edition
section: "Manage Your Organization"
date: 2024-02-06 16:36:44
---

!!! error Enterprise
    In Annotation Hub Community Edition, there are relatively limited options available for user management. 
    
    In Annotation Hub Enterprise, you can set roles for users, restrict their permissions, delete and deactivate users, and view detailed logs of user actions. For more information about the user management capabilities of Annotation Hub Enterprise, see [User management overview](https://docs.humansignal.com/guide/manage_users) in the Enterprise documentation. To start a free trial, [click here](https://app.heartex.com/user/trial).  

## Retrieve user info from the command line

You can retrieve information about a user, including the API user token for a user, from the command line after starting Annotation Hub.
...
Users can also retrieve their own tokens from the Annotation Hub app. For more information, see [Manage your user account settings](user_account). 


## Review existing accounts in Annotation Hub

You can view the organization user list from Annotation Hub:
...
On the server running Annotation Hub, run the following command. And then when prompted, type the username and the new password:
