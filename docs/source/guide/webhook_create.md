---
title: Create custom events for webhooks in Annotation Hub
short: Webhook development
type: guide
tier: all
order: 410
order_enterprise: 410
meta_title: Create Custom Webhooks in Annotation Hub
meta_description: Annotation Hub documentation for creating custom webhook event triggers to create custom integrations between Annotation Hub and your machine learning pipeline
...
If you want to trigger custom events for webhooks in Annotation Hub, you can extend the webhook event model.
