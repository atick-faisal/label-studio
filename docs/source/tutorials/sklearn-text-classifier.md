...
meta_description: Annotation Hub tutorial for text classification using Scikit-Learn and Annotation Hub.
...
This tutorial explains the basics of using a Machine Learning (ML) backend with Annotation Hub using a simple text classification model powered by the [scikit-learn](https://scikit-learn.org/stable/) library.
