...
LabelStudio DataManager is a vital component within the Annotation Hub ecosystem, designed to efficiently manage and navigate through annotated data. It provides users with advanced capabilities to organize, filter, and browse their datasets seamlessly.


### Features

DataManager boasts several key features, enhancing data handling within Annotation Hub:
...
- Integration with Annotation Hub Frontend: Ensures cohesive functionality with the Annotation Hub Frontend.
...
- **`yarn dm:watch`: Build DataManager continuously.**
    - This script is essential for development. It continuously builds DataManager, allowing developers to see their changes in real-time within the Annotation Hub environment.
...
DataManager integrates closely with Annotation Hub, handling various events:
