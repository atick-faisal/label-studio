...
meta_title: Annotation Hub tutorial to run Hugging Face NER backend
meta_description: This tutorial explains how to run a Hugging Face NER backend in Annotation Hub. 
categories:
...
# Hugging Face NER model with Annotation Hub

This project uses a custom machine learning backend model for Named Entity Recognition (NER) with Hugging Face's transformers and Annotation Hub.
...
- If you want to fine-tune the model, you can use the Annotation Hub interface to provide training data and train the model.
...
This ML backend works with the default NER template from Annotation Hub. You can find this by selecting Annotation Hub's pre-built NER template when configuring the labeling interface. It is available under **Natural Language Processing > Named Entity Recognition**:
