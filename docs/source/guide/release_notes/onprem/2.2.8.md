...
## Annotation Hub Enterprise 2.2.8
...
This section highlights the breaking changes, new features and enhancements, and bug fixes in Annotation Hub Enterprise 2.2.8. 

### New features and enhancements
Annotation Hub Enterprise 2.2.8 introduces the following new features and enhancements.
...
### Bugfixes
Annotation Hub 2.2.8 includes the following bug fixes:
