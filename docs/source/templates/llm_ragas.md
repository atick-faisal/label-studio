...
!!! info Tip
    If you are just looking to experiment with this template and the ML backend, you can clone the [Annotation Hub repository](https://github.com/HumanSignal/label-studio) and use the `label-studio\docs` directory as your context. 
...
[
  {
    "id": 1,
    "data": {
      "text": "What are the system requirements for Annotation Hub?"
    }
  },
  {
    "id": 2,
    "data": {
      "text": "How do I update Annotation Hub?"
    }
  }
]
```
