...
order: 560
is_new: t
meta_title: Create a ranked dataset for text-to-image models with Annotation Hub
meta_description: Template for creating a ranked dataset for text-to-image models with Annotation Hub for your machine learning and data science projects.
---
...
1. Create a  new project in Annotation Hub
...
Using the Python SDK you can export the dataset with annotations from Annotation Hub.
